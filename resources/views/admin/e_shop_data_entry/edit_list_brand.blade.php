                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            @endif
                            <br/>
                            <form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ action('EShopDataEntry\BrandsController@update',['brand' => $brand->id]) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="name" required="required"
                                               class="form-control col-md-7 col-xs-12" value="{{ $brand->name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="sort" name="sort" required="required"
                                               class="form-control col-md-7 col-xs-12" value="{{ $brand->sort }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">                                        
                                        ...
                                        <div class="input-append">
                                            <input id="fieldID" type="text" class="form-control pathimage" onchange="getPreviewImg(this);" name="image" value="{{$brand->image}}">
                                            ...
                                            <img class="img-preview" style="margin-top:15px;max-height:100px;" src="/image/{{ $brand->image }}">
                                        </div>   
                                    </div>     
                                    </div>
                                    </div>
