                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="post" id="demo-form2" data-parsley-validate
                                  ...
                                  action="{{ action('EShopDataEntry\ValuesController@update',['value' => $value[0]->id]) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="name" required="required"
                                               class="form-control col-md-7 col-xs-12" value="{{ $value[0]->name }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <select class="form-control" name="option_id" required="required">
                                            @foreach($options as $option)
                                                @if($option->id == $value[0]->option->id)
                                                    <option value="{{ $option->id }}" selected>{{ $option->name }} (id:{{ $option->id }})</option>
                                                @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" min="0" name="sort_order" id="sort_order" required="required"
                                               class="form-control col-md-7 col-xs-12" value="{{ $valueOption[0]->sort_order }}">
                                    </div>
                                </div>
                                <!--block upload image -->
                                <div class="x_panel">
                                        ...
                                        <div class="input-group block-image">
                                          <span class="input-group-btn">
                                            ...
                                            <input id="fieldID" type="text" class="form-control pathimage" onchange="getPreviewImg(this);"
                                                   name="image"  value="{{ $valueOption[0]->image }}">
                                        </div>
                                        <img class='img-preview' src="{{asset('image/'.$valueOption[0]->image)}}" style="margin-top:15px;max-height:100px;">
                                    </div>
                                </div>
                                <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <!--<a class="btn btn-primary" href="{{ secure_url('admin/products/') }}">Back</a>-->
